...
class TextEditor(tk.Tk):
    ...
    def initUI(self):
        ...
        self.language_dropdown = tk.OptionMenu(self, self.language_var, "AUTOGPT RNN SELF COMPILING BOT 1.0x.A""GPT-X AUTOCOMPILE AUTOMATICLLY DETECTS EVERYTHING","Toontoonemu GCC Cross Compiler [Automaticlly compiles the format and installs everything also generates code","Python", "HTML", "C#", "Rust", "Assembly", "Autotranslate", "Query Google", "OpenAI CODEX (BETA)")
