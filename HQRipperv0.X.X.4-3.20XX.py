...
class TextEditor(tk.Tk):
    ...
    def initUI(self):
        ...
        self.language_dropdown = tk.OptionMenu(self, self.language_var, "AUTOGPT - ZEROSHOT 1.0 GAME GENERATOR AND GCC COMPILER + NINTENDO AIO DENA RIPPING KIT","GPT-X AUTOCOMPILE AUTOMATICLLY DETECTS EVERYTHING","Toontoonemu GCC Cross Compiler [Automaticlly compiles the format and installs everything also generates code","Python", "HTML", "C#", "Rust", "Assembly", "Autotranslate", "Query Google", "OpenAI CODEX (BETA)")
